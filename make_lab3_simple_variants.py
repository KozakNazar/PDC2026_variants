##########################################
# N.Kozak // Lviv'2026                   #
#    file: make_lab3_simple_variuants.py #
##########################################
import random
...
def make_lab4_variants_and_save_in_docx(year, group, variant_count, output_file):
    ...
    for index in range(0, variant_count):
        ...
        if (index + 1) % 2 == 1:
            table.cell(row_offset, 1).text = "решітка виду 2х4"
        else:
            table.cell(row_offset, 1).text = "решітка виду 4х2"
